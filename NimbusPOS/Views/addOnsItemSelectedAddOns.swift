//
//  addOnsItemSelectedAddOns.swift
//  NimbusPOS
//
...
class addOnsItemSelectedAddOns: UITableViewCell {
    ...
    override func setSelected(_ selected: Bool, animated: Bool) {
        ...
        if selected == true {
            NIMBUS.OrderCreation?.removeSelectedAddOnFromOrderItem(selectedAddOn: self.cellAddOnItem!)
        }
    }
}
